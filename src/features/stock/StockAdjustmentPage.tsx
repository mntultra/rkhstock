...
export default function StockAdjustmentPage() {
  ...
  return (
    <div className="max-w-full mx-auto space-y-6">
      ...
      {/* Header */}
      <Card className="flex flex-col md:flex-row md:items-center justify-between gap-4 animate-fade-in-up">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 self-start md:self-auto w-full sm:w-auto">
          <div className="text-sm font-bold text-gray-500 sm:text-right w-full sm:w-auto shrink-0">
            วันที่ทำรายการ:
          </div>
          <DatePicker
            value={docDate}
          ...
          />
          <div className="text-sm font-bold text-gray-500 sm:text-right w-full sm:w-auto shrink-0 ml-0 sm:ml-4">
