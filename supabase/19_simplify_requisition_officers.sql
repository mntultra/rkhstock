...
-- 1. ลบคอลัมน์ issuer_id และ issuer_position ที่เคยเพิ่มในตาราง requisitions
ALTER TABLE public.requisitions 
  DROP COLUMN IF EXISTS issuer_id CASCADE,
  DROP COLUMN IF EXISTS issuer_position CASCADE;
