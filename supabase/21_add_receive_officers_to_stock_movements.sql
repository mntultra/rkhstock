...
--   2. เพิ่ม issuer_id — ผู้จ่ายเวชภัณฑ์ (คลังหลัก)
...
ALTER TABLE public.stock_movements
  ...
  ADD COLUMN IF NOT EXISTS issuer_id  UUID REFERENCES public.officers(id) ON DELETE SET NULL,
...
COMMENT ON COLUMN public.stock_movements.issuer_id     IS 'ผู้จ่ายเวชภัณฑ์ (คลังหลัก) — FK officers';
